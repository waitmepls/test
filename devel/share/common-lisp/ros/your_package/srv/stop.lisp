...
(cl:defmethod cl:initialize-instance :after ((m <stop-request>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'stop-request)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name your_package-srv:<stop-request> is deprecated: use your_package-srv:stop-request instead.")))
...
(cl:defmethod cl:initialize-instance :after ((m <stop-response>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'stop-response)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name your_package-srv:<stop-response> is deprecated: use your_package-srv:stop-response instead.")))
