...
class subtractRequest {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type subtractRequest
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type subtractRequest
    let len;
    let data = new subtractRequest(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new subtractRequest(null);
    if (msg.A !== undefined) {
      resolved.A = msg.A;
    }
    else {
...
class subtractResponse {
  ...
  static serialize(obj, buffer, bufferOffset) {
    // Serializes a message object of type subtractResponse
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    //deserializes a message object of type subtractResponse
    let len;
    let data = new subtractResponse(null);
  ...
  static Resolve(msg) {
    ...
    const resolved = new subtractResponse(null);
...
module.exports = {
  ...
  datatype() { return 'your_package/subtract'; }
};
